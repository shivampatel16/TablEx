...
os.chdir("/home/shivam/Desktop/myEdited XMLs 2/")
subprocess.call(['mkdir', '/home/shivam/Desktop/myGenerated Test File/'])
directory = "/home/shivam/Desktop/myEdited XMLs 2/"
...
for fname in file_name:
    ...
    if columns_in_template_file_check == 0:
        ...
        with open("/home/shivam/Desktop/myGenerated Test File/test.data", "a") as myfile:
            for i in a:
...
with open("test.data", "r", encoding = "utf8") as f:
    with open("test_edited.data", "w", encoding = "utf8") as f1:
        for line in f:
